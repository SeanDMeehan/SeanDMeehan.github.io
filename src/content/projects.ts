...
import SatelliteOrbitalPath from "../assets/papers/SatelliteOrbitalPath.pdf";
...
export const projects: Project[] = [
    {
        ...
        links: [
            { label: "PDF", href: SatelliteOrbitalPath }
        ],
        image: satelliteML,
        featured: true
    },
    {
        ...
        links: [
            { label: "GitHub", href: "https://github.com/jthunt1515/NatTwentyOne-2.0" }
        ],
        image: natTwentyOne,
        featured: true
    },
